...
import com.edunge.bukinz.model.LgaResult;
import com.edunge.bukinz.model.PartyLgaResult;
...
public class DashboardResponse extends BaseResponse{
    ...
    public DashboardResponse(String code, String message, Long totalStates, Long totalLgas, Long totalSenatorialDistricts, Integer totalRegisteredVotes, Integer totalAccreditedVotes, Integer totalVoidVotes, Integer totalVoteCounts, Long totalWards, Long totalPollingUnits, Long lgaWithResults, Long wardsWithResults, Long pollingUnitsWithResults, Double resultsReceived, List<LgaResult> lgaResults, List<PartyLgaResult> partyLgaResults) {
        super(code, message);
        this.totalStates = totalStates;
        this.totalLgas = totalLgas;
        this.totalSenatorialDistricts = totalSenatorialDistricts;
    ...
    public DashboardResponse(String code, String message, Long totalStates, Long totalLgas, Long totalSenatorialDistricts, Integer totalRegisteredVotes, Integer totalAccreditedVotes, Integer totalVoteCounts, Long totalWards, Long totalPollingUnits, Long lgaWithResults, Long wardsWithResults, Long pollingUnitsWithResults, Double resultsReceived, List<LgaResult> lgaResults) {
        super(code, message);
        this.totalStates = totalStates;
        this.totalLgas = totalLgas;
        this.totalSenatorialDistricts = totalSenatorialDistricts;
