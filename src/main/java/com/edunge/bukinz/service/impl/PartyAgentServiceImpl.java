...
import com.edunge.bukinz.dto.PartyAgentDto;
...
import com.edunge.bukinz.response.PartyAgentResponse;
...
@Service
@Slf4j
public class PartyAgentServiceImpl {
    ...
    @Autowired
    public PartyAgentServiceImpl(LgaRepository lgaRepository, PartyAgentRepository partyAgentRepository, PollingUnitRepository pollingUnitRepository, WardRepository wardRepository, UserServiceImpl userService, StateRepository stateRepository) {
    ...
    private void savePartyAgent(String surname,
        ...
        try{
            ...
            log.info("Party agent could not be saved");
        }
    }
