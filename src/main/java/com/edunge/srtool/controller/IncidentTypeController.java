...
@Tag(name = "Manage Incident Type", description = "Endpoints to manage Incident Type")
...
public class IncidentTypeController {
    ...
    @Operation(summary = "Retrieve all Incident Typ.")
    ...
    @Operation(summary = "Find Incident Type by code.")
    ...
    @Operation(summary = "Find Incident Typ by id.")
    ...
    @Operation(summary = "Save Incident Typ to the DB")
    ...
    @Operation(summary = "Update Incident Typ to the DB")
    ...
    @Operation(summary = "Delete Incident Typ by id.")
    ...
    @Operation(summary = "Filter Incident type by name.")
