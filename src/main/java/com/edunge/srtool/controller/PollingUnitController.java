...
@Tag(name = "Manage Polling Unit", description = "Endpoints to manage Polling Unit")
...
public class PollingUnitController {
    ...
    @Operation(summary = "Retrieve all polling units.")
    ...
    @Operation(summary = "Find Polling unit by code.")
    ...
    @Operation(summary = "Find Polling Unit by id.")
    ...
    @Operation(summary = "Save Polling Unit to the DB")
    ...
    @Operation(summary = "Update Polling Unit to the DB")
    ...
    @Operation(summary = "Delete Polling Unit by id.")
    ...
    @Operation(summary = "Filter polling unit by name.")
    ...
    @Operation(summary = "Find polling unit by ward id.")
    ...
    @Operation(summary = "Find polling unit by lga id.")
    ...
    @Operation(summary = "Find polling unit by state id.")
    ...
    @Operation(summary = "Find polling unit by senatorial id.")
