...
@Tag(name = "Manage Election", description = "Endpoints to manage Election")
...
public class ElectionController {
    ...
    @Operation(summary = "Retrieve all election.")
    ...
    @Operation(summary = "Retrieve all election types.")
    ...
    @Operation(summary = "Find election by code.")
    ...
    @Operation(summary = "Find election by id.")
    ...
    @Operation(summary = "Save election to the DB")
    ...
    @Operation(summary = "Update election to the DB")
    ...
    @Operation(summary = "Filter election by name.")
