...
@Tag(name = "Manage Voting Level", description = "Endpoints to manage Voting Level")
...
public class VotingLevelController {
    ...
    @Operation(summary = "Retrieve all Voting Level.")
    ...
    @Operation(summary = "Find Voting Level by code.")
    ...
    @Operation(summary = "Find Voting Level by id.")
    ...
    @Operation(summary = "Save Voting Level to the DB")
    ...
    @Operation(summary = "Update Voting Level to the DB")
    ...
    @Operation(summary = "Delete Voting Level by id.")
