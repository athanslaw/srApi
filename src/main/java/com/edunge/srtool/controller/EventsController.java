...
@Tag(name = "Manage Events", description = "Endpoints to manage Events")
...
public class EventsController {
    ...
    @Operation(summary = "Find Event Record by id.")
    ...
    @Operation(summary = "Find Event Record by state.")
    ...
    @Operation(summary = "Find Event Record by district.")
    ...
    @Operation(summary = "Find Event Record by zone.")
    ...
    @Operation(summary = "Find Event Record by lga.")
    ...
    @Operation(summary = "Find Event Record by ward.")
    ...
    @Operation(summary = "Find Event Record by Polling Unit.")
    ...
    @Operation(summary = "Save event record to the DB")
    ...
    @Operation(summary = "Update Event Record to the DB")
    ...
    @Operation(summary = "Delete Event Record by id.")
    ...
    @Operation(summary = "Retrieve active events.")
    ...
    @PostMapping("/event")
    @Operation(summary = "Save event to the DB")
