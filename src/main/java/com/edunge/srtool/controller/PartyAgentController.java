...
@Tag(name = "Manage Party Agent", description = "Endpoints to manage Party Agent")
...
public class PartyAgentController {
    ...
    @Operation(summary = "Retrieve all Party Agents.")
    ...
    @Operation(summary = "Find party agent by code.")
    ...
    @Operation(summary = "Find party agent by id.")
    ...
    @Operation(summary = "Save party agent to the DB")
    ...
    @Operation(summary = "Update party agent to the DB")
    ...
    @Operation(summary = "Delete party agent by id.")
    ...
    @Operation(summary = "Find party agent by name.")
    ...
    @Operation(summary = "Filter by polling unit.")
