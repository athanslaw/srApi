...
@Tag(name = "Manage Result Per Party", description = "Endpoints to manage Result Per Party")
...
public class ResultPerPartyController {
    ...
    @Operation(summary = "Retrieve all result per party.")
    ...
    @Operation(summary = "Save result per party to the DB")
    ...
    @Operation(summary = "Update result per party to the DB")
    ...
    @Operation(summary = "Delete result per party by id.")
    ...
    @Operation(summary = "Filter result per party by name.")
